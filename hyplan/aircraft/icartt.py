...
_COLUMN_PATTERNS = [
    ...
    ("latitude",         [r"\blatitude\b",      r"\blat[_\s-]*deg\b", r"\bgpslat\b"],   "deg"),
    ("longitude",        [r"\blongitude\b",     r"\blon[_\s-]*deg\b", r"\bgpslon\b"],   "deg"),
    ("altitude",         [r"^pressure[_\s-]*altitude", r"^press[_\s-]*alt"],            "ft"),
    ("altitude_gps_ft",  [r"\bgps[_\s-]*alt", r"^gps[_\s-]*altitude\b"],                "m"),
    ("altitude_radar_ft",[r"\bradar[_\s-]*altitude", r"\bradar[_\s-]*alt"],             "ft"),
    ("groundspeed",      [r"\bground[_\s-]*speed\b"],                                   "kt"),
    ("tas_kt",           [r"\btrue[_\s-]*air[_\s-]*speed\b", r"\btrueairspd\b",
                          r"\btas[_\s-]*ms\b", r"\btas\b"],                             "kt"),
    ("ias_kt",           [r"\bindicated[_\s-]*air[_\s-]*speed\b", r"\bias\b"],          "kt"),
    ("mach",             [r"\bmach[_\s-]*number\b", r"\bmach\b"],                       "mach"),
    ("vertical_velocity",[r"\bvertical[_\s-]*speed\b", r"\bvert[_\s-]*wind"],           "fpm"),
    ("true_heading",     [r"\btrue[_\s-]*heading\b", r"^heading\b", r"\bhdg[_\s-]*deg\b"],"deg"),
    ("track",            [r"\btrack[_\s-]*angle\b", r"\btrack\b"],                      "deg"),
    ...
    ("aoa_deg",          [r"\bangle[_\s-]*of[_\s-]*attack\b", r"\baoa\b"],              "deg"),
    ("wind_speed_kt",    [r"\bwind[_\s-]*speed\b", r"\bwspd[_\s-]*ms\b"],               "kt"),
    ("wind_direction_deg",[r"\bwind[_\s-]*direction\b", r"\bwdir[_\s-]*deg\b"],         "deg"),
    ("ambient_temp_c",   [r"\bstatic[_\s-]*air[_\s-]*temp", r"\bambtemp\b",
                          r"\btstat[_\s-]*degc\b", r"\bambient[_\s-]*temp\b"],          "C"),
