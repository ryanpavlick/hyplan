...
Several aircraft models are calibrated from in-situ flight-state data rather than brochure values alone. HyPlan's calibration notebooks derive climb, cruise, descent, turn, and approach parameters from IWG1 or ICARTT navigation/meteorological products, and the resulting aircraft definitions carry provenance records that distinguish data-fit, brochure-derived, and inferred values.
