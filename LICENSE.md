...
Copyright (c) 2024-2026, United States Government, as represented by the
Administrator of the National Aeronautics and Space Administration.
All rights reserved.

This software is licensed under the Apache License, Version 2.0 (above).
...
HyPlan reads DE421 via the Skyfield library:
...
The file `hyplan/data/faa_radar_exclusion_zones.geojson` is derived from
publicly available U.S. Federal Aviation Administration data.
