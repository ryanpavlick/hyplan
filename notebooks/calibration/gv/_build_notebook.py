...
NASA 95 G-V Orion data delivered as a single concatenated
...
climb_pts = [(0, ROTATION_TAS_KT)] + schedule_pts(
    climb_tas, [10000, 20000, 30000, 40000, 45000, 50000]
)

# Cruise: G-V typical band FL410-FL510 with step climbs.  Below
# FL410 cruise-labeled bins are mostly transient level-offs.
cruise_pts = schedule_pts(cruise_tas, [41000, 45000, 47000, 49000, 51000])

# Descent: low-altitude anchor + descent-phase medians up to
# cruise ceiling.
descent_pts = schedule_pts(descent_tas, [10000, 20000, 30000, 40000, 45000, 50000])
