...
def main() -> None:
    ...
    print()
    print("=" * 70)
    print("PASTE-READY KingAirB200() PERFORMANCE BLOCK")
    print("=" * 70)
    print(f"# Calibrated against {len(sorties)} multi-campaign ICARTT sorties:")
    print("# ACT-AMERICA, DISCOVER-AQ (CA / CO / TX), KORUS-AQ, LMOS.")
