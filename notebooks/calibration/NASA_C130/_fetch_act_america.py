"""Download ACT-America C-130H (NASA 436) IWG1 files into data/NASA_C130/.
...
omit it), and writes the result as ``data/NASA_C130/n436_<YYYY-MM-DD>.txt``.

Idempotent — skips dates already present.

Run from the repo root: ``python notebooks/calibration/NASA_C130/_fetch_act_america.py``.
"""
...
DEST_DIR = Path(__file__).resolve().parents[2] / ".." / "data" / "NASA_C130"
