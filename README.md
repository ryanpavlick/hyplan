...
HyPlan's documentation, instrument modules, and aircraft catalog name
specific commercial products (e.g. Phase One, Riegl, Xenics, Headwall,
Rodenstock, Tamron, PCO, Cessna, Beechcraft King Air, Gulfstream) to
identify the hardware used on real airborne campaigns and to make the
modelled parameters traceable to manufacturer specifications.

> References herein to any specific commercial products, processes or
> services or the use of any trade, firm or corporation name are for
> the information and convenience of the user and do not constitute
> endorsement, recommendation or favoring by the US government or
