...
**flight_plan.py:** fuel burn estimation per segment; multiple altitude levels in single plan; pilot-ready briefing sheet export
...
**exports.py:** import flight lines from KML/shapefile; `--strict` mode that raises on missing data

**airspace.py:** filtering by type (show only RESTRICTED, etc.); handle "no ceiling" SUA special case

**gui:** hover to reveal solar elevation times; copy/rotate/nudge individual lines; aircraft icons on map; wind barbs overlay
